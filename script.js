const recipes = [
  ...
  },
  {
    ...
    ingredients: ["皮蛋 3个", "青尖椒 5根（约250克）", "蒜 3瓣", "生抽 1.5勺", "香醋 1勺", "白糖 半小勺", "芝麻油 半小勺"],
    steps: [
      "皮蛋剥壳，用干净的刀切成四瓣，先整齐铺在有浅边的盘中。",
      "青尖椒洗净并擦干，放入不加油的平底锅，中火边煎边按压，直至表面起虎皮、椒肉变软。",
      "青椒稍微放凉后去蒂；怕辣可以去掉部分籽，再撕成粗条。",
      "蒜放入碗中压成蒜泥，加入青椒，用擀面杖末端或勺背轻轻捣碎。",
      "加入生抽、香醋、白糖和芝麻油拌匀，铺在皮蛋上，静置 5 分钟入味即可。"
    ],
    tip: "青椒下锅前要擦干，干煎更容易形成虎皮；皮蛋剥开后尽快食用，剩余凉菜不要长时间放在室温下。"
  },
  {
    id: 21,
    title: "辣椒炒肉",
    ...
    ingredients: ["猪梅花肉 250克", "青尖椒 5根（约250克）", "蒜 3瓣", "豆豉 1小勺", "生抽 1.5勺", "老抽 半小勺", "料酒 半勺", "淀粉 1小勺", "白糖 少许", "食用油 1小勺"],
    steps: [
      "猪梅花肉逆着纹理切成薄片，加入料酒、半勺生抽和淀粉抓匀，腌制 10 分钟。",
      "青尖椒斜切成段；平底锅不放油，中火把辣椒煸至表面起虎皮、边缘微微变软，盛出备用。",
      "锅中放 1 小勺油，加入肉片快速划散，翻炒至肉片完全变色。",
      "加入蒜片和豆豉炒出香味，再倒回青椒翻炒均匀。",
      "加入剩余生抽、老抽和少许白糖，大火翻炒约 1 分钟，确认猪肉熟透后立即出锅。"
    ],
    tip: "用梅花肉比五花肉更清爽，锅里也不需要太多油；不太能吃辣时，可去掉辣椒籽或用一半青椒替换。"
  },
  {
    id: 22,
    title: "饺子",
    ...
    ingredients: ["现成饺子皮 24张", "猪前腿肉末 200克", "大白菜 250克", "葱 2根", "姜 1小块", "生抽 1.5勺", "蚝油 半勺", "芝麻油 1小勺", "盐 适量", "白胡椒粉 少许", "清水 3勺"],
    steps: [
      "大白菜洗净切碎，加入半小勺盐拌匀，静置 10 分钟后攥干多余水分。",
      "葱和姜切末，加入 3 勺清水浸泡片刻，做成简单的葱姜水。",
      "猪肉末加入生抽、蚝油和白胡椒粉，分次倒入葱姜水，始终朝同一方向搅拌至肉馅有黏性。",
      "加入白菜和芝麻油拌匀；取一张饺子皮放适量馅料，边缘蘸少许清水后捏紧，包好的饺子轻盖湿布防干。",
      "锅中烧足量水，水开后分批下饺子，用勺背轻推防止粘底；再次沸腾后转中火煮约 4 至 5 分钟。",
